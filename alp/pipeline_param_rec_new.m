...
% this was originally assoc_learning/matlab/pipeline_param_rec
...
obs_params = repmat(bopars.p_obs.p,n_sim_t,1); % will probably only one column, but keep for consistency
